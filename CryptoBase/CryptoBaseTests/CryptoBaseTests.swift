...
class CryptoBaseTests: XCTestCase {
    func testIdentify() {
        XCTAssertEqual(CryptoBase.identify(), "CryptoBase")
    }

    func testSHA() {
        let input = "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq";
        let digest256 = CryptoBase.sha256(data: input.utf8)
        XCTAssertEqual(digest256.hex, "248d6a61d20638b8e5c026930c3e6039a33ce45964ff2167f6ecedd419db06c1")
        let digest512 = CryptoBase.sha512(data: input.utf8)
    ...
    func testHMACSHA() {
        ...
        let hmac256 = CryptoBase.hmacSHA256(key: key, message: message)
        XCTAssertEqual(hmac256.hex, "b0344c61d8db38535ca8afceaf0bf12b881dc200c9833da726e9376c2e32cff7")
        let hmac512 = CryptoBase.hmacSHA512(key: key, message: message)
    ...
    func testPBKDF2HMACSHA256() {
        let key = CryptoBase.pbkdf2HMACSHA256(pass: "password".utf8, salt: "salt".utf8, iterations: 1, keyLen: 32)
        XCTAssertEqual(key.hex, "120fb6cffcf8b32c43e7225256c4f837a86548c92ccc35480805987cb70be17b")
    }

    func testCRC32() {
        let input = "Hello, world!"
        let checksum = CryptoBase.crc32(data: input.utf8)
        XCTAssertEqual(checksum.bigEndian.hex, "e6c6e6eb")
        let checksumN = CryptoBase.crc32n(data: input.utf8)
