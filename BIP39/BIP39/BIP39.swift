import Foundation
@_implementationOnly import CBIP39
...
public func word(for index: Int) throws -> String {
...
public func index(for word: String) throws -> Int {
...
public func seed(for string: String) -> Data {
...
public func decode(_ words: String) throws -> Data {
